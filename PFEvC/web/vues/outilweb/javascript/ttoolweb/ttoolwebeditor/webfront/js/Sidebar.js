 ...
 * Adds the general palette to the sidebar.
 */
 	Sidebar.prototype.addSysMLPalette = function(expand)
	{
		...
		this.addPalette('sysml', 'SysML', expand || false, mxUtils.bind(this, function(content)
		{
